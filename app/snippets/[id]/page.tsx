...
import { getComments, getSnippetById } from "@/lib/queries";

async function SnippetDetailPage() {
  const snippetId = useParams().id;

  const snippet = await getSnippetById(snippetId as string);
  const comments = await getComments(snippetId as string);
